...
- [X] Fix any failing CI/CD checks
- [X] Implement pull request workflow

## Deployment
- [X] Prepare data for Fabric upload
- [X] Create Fabric notebook
- [X] Deploy package to Fabric
- [X] Test in Fabric environment
